...
<div class="container-fluid" style="padding: 0" data-aos="fade-in" data-aos-delay="50" data-aos-duration="1000">
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="partners-heading w-50 ml-auto mr-auto pl-3">
            <h2>Melco</h2>
            <p>Modular Head system EMT16X</p>
...
<div class="container px-5">
    <div class="row pt-5" data-aos="fade-in" data-aos-delay="50" data-aos-duration="1000">
        ...
        <div class="col-md">
            <h4>
                ...
                machines with the advantages of conventional single-head embroidery machines. This is done by connection
                between 2 and 3o single-head machines over a network and controlling them from a single computer. This
                allows your to..
            </h4>
            <p style="font-size: 1.3rem;"> <img src="{{asset('img/partners/melco-dot.png')}}"
                ...
                them and change settings simultaneously - just like on a conventional multi-head mchine. this minimizes
                set-up times.
            </p>
            <p style="font-size: 1.3rem;"> <img src="{{asset('img/partners/melco-dot.png')}}"
                    style="margin-left: -25px;"> To have all machine produce independently of each other = just like a
                single-head machine. So when one machine is at a standstill, all other machines continue to product.
            </p>
            <p style="font-size: 1.3rem;"> <img src="{{asset('img/partners/melco-dot.png')}}"
                    style="margin-left: -25px;"> Minimize downtime so drastically that your productivity can increase by
                up to 100%.
            </p>
        </div>
    </div>
    <div class="row pt-5" data-aos="fade-in" data-aos-delay="50" data-aos-duration="1000">
        ...
        <div class="col-md">
            ...
            <p style="font-size: 1.3rem;"> <img src="{{asset('img/partners/melco-dot.png')}}"
                    style="margin-left: -25px;">Instead of stopping the whole production line, only one machine stopss
                when a thread or needle breaks - solving the problem does not require the aggravation of other machines.
            </p>
