                ...
                <div class="d-flex justify-content-between">
                    ...
                    <div class="d-flex">
                        ...
                        <ul class="d-flex ml-auto">
                            ...
                            <li class="navbar-nav">
                                <a class="nav-link" @if (app()->getLocale() == $locale) style="text-decoration:
                                    underline" @endif
                                    href="{{ route(\Illuminate\Support\Facades\Route::currentRouteName(), [$locale, Request::segment(4)??'']) }}"
                                    class="nav-link">{{strtoupper($locale)}}</a>
                            </li>
                            @endforeach
                        </ul>
                    </div>
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                                ...
                                <li><a href="{{route('solutions.brands', app()->getLocale())}}"
                                        class="dropdown-item">Brands</a></li>
                                <li><a href="{{route('solutions.ecommerce', app()->getLocale())}}"
                                        class="dropdown-item">E-commerce</a></li>
                                <li><a href="{{route('solutions.industrials', app()->getLocale())}}"
                                        class="dropdown-item">Industrial</a></li>
                            </ul>
                        </li>
